# 9.26.2017: New semester, new goals
...
class Application(tk.Frame): 
    ...
    def initUI(self):
        ...
        proofMenu.add_cascade(label="End Subproof", command=self.endSubproof)
    ...
    def addSubproof(self):
        self.step += 20
        self.offset += 20
        self.addLine(self.offset, self.step)
    ...
    def addLine(self, xStart, yStart):
        ...
        num.set(self.amount)
        self.stepNumber[len(self.stepNumber) - 1].place(x=xStart,y=yStart)
        
        self.sentence.append(Text(self, width=50, height=1, padx=5, pady=5))
        self.sentence[len(self.sentence) - 1].pack()
        self.sentence[len(self.sentence) - 1].place(x=xStart+40,y=yStart)
        ...
        self.inferenceRules[len(self.inferenceRules) - 1].place(x=xStart+395,y=yStart)
        ...
        self.reference[len(self.reference) - 1].place(x=xStart+595,y=yStart)
        ref.set("Test")
